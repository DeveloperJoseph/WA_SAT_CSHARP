<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="WF_MANTENIMIENTO_DOCUMENTO.aspx.cs" Inherits="WA_SAT_CSHARP.VISTA.WF_MANTENIMIENTO_DOCUMENTO" %>
        ...
        <div class="container">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtDocumentoID" runat="server" placeholder="Ingresar código"></asp:TextBox>
                    <br />
                </div>
                <div class="form-group">
                ...
                <br />
                <br />
                <asp:Label ID="LabelMensaje" runat="server" CssClass="col-form-label text-danger" Text=""></asp:Label>

                <br />
                <br />
            </div>
        </div>
        <asp:GridView ID="GridViewDocumento" runat="server" CssClass="table table-sm  table-hover" AllowCustomPaging="True" HorizontalAlign="Center" PageSize="5">
        </asp:GridView>
