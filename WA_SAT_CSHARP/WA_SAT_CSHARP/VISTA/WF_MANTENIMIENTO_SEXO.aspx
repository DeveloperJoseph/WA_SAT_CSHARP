<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WF_MANTENIMIENTO_SEXO.aspx.cs" Inherits="WA_SAT_CSHARP.VISTA.WF_MANTENIMIENTO_SEXO" %>
...
<head runat="server">
    ...
    <title>MANTENIMIENTO DE SEXOS</title>
</head>
<body class="bg-dark">
    ...
    <form id="form1" runat="server" class="form-control-sm">
        <div class="container">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtSexoID" runat="server" placeholder="Ingresar código"></asp:TextBox>
                    <br />
                </div>
                <div class="form-group">
        ...
        <div class="bg-light">
        <asp:GridView ID="GridViewSexo" runat="server" CssClass="table table-sm  table-hover" AllowCustomPaging="True" HorizontalAlign="Center" PageSize="5">
        </asp:GridView>
            </div>
    </form>
</body>
